...
import { CHAT_MESSAGE_EVENT } from '../shared/shared-client.js';
...
view.on("chatmessage", (text) => {
    alt.emitServer(CHAT_MESSAGE_EVENT, text); // Отправляем сообщение на сервер
    opened = false;
...
alt.onServer(CHAT_MESSAGE_EVENT, addMessage); // Обработка сообщений от сервера
...
// Вызов функции напрямую, без использования CommonJS экспорта
